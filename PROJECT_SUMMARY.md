...
The application uses pre-bundled Vanilla CSS and JavaScript in `public/css/app.css` and `public/js/app.js`. No Node.js / Vite build step is needed during deployment.
