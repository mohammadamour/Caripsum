            ...
            >
                ...
                <div class="form-content">
                    <div class="form-details">
                                ...
                                <div class="col">
                                    <label class="checkbox">
                                        <input
                                            ...
                                            value="1"
                                            {{ old('air_conditioning', $car->features?->air_conditioning) ? 'checked' : '' }}
                                        />
                                        Air Conditioning
                                    </label>
                                    ...
                                    <label class="checkbox">
                                        <input
                                            ...
                                            name="power_windows"
                                            value="1"
                                            {{ old('power_windows', $car->features?->power_windows) ? 'checked' : '' }}
                                        />
                                        Power Windows
                                    </label>
                                    ...
                                    <label class="checkbox">
                                        <input
                                            ...
                                            value="1"
                                            {{ old('power_door_locks', $car->features?->power_door_locks) ? 'checked' : '' }}
                                        />
                                        Power Door Locks
                                    </label>
                                    ...
                                    <label class="checkbox">
                                        <input
                                            ...
                                            name="abs"
                                            value="1"
                                            {{ old('abs', $car->features?->abs) ? 'checked' : '' }}
                                        />
                                        ABS
                                    </label>
                                    ...
                                    <label class="checkbox">
                                        <input
                                            ...
                                            name="cruise_control"
                                            value="1"
                                            {{ old('cruise_control', $car->features?->cruise_control) ? 'checked' : '' }}
                                        />
                                        Cruise Control
                                    </label>
                                    ...
                                    <label class="checkbox">
                                        <input
                                            ...
                                            value="1"
                                            {{ old('bluetooth_connectivity', $car->features?->{'bluetooth-connectivity'}) ? 'checked' : '' }}
                                        />
                                ...
                                <div class="col">
                                    <label class="checkbox">
                                        <input
                                            ...
                                            name="remote_start"
                                            value="1"
                                            {{ old('remote_start', $car->features?->remote_start) ? 'checked' : '' }}
                                        />
                                        Remote Start
                                    </label>
                                    ...
                                    <label class="checkbox">
                                        <input
                                            ...
                                            name="gps_navigation"
                                            value="1"
                                            {{ old('gps_navigation', $car->features?->gps_navigation) ? 'checked' : '' }}
                                        />
                                    ...
                                    <label class="checkbox">
                                        <input
                                            ...
                                            name="heated_seats"
                                            value="1"
                                            {{ old('heated_seats', $car->features?->heated_seats) ? 'checked' : '' }}
                                        />
                                        Heated Seats
                                    </label>
                                    ...
                                    <label class="checkbox">
                                        <input
                                            ...
                                            value="1"
                                            {{ old('climate_control', $car->features?->climate_control) ? 'checked' : '' }}
                                        />
                                        Climate Control
                                    </label>
                                    ...
                                    <label class="checkbox">
                                        <input
                                            ...
                                            value="1"
                                            {{ old('rear_parking_sensors', $car->features?->rear_parking_sensors) ? 'checked' : '' }}
                                        />
                                    ...
                                    <label class="checkbox">
                                        <input
                                            ...
                                            name="leather_seats"
                                            value="1"
                                            {{ old('leather_seats', $car->features?->leather_seats) ? 'checked' : '' }}
                                        />
                                        Leather Seats
                                    </label>
                                </div>
                        ...
                        <div class="form-group">
                            <label class="checkbox">
                                <input type="checkbox" name="published" {{ old('published', $car->published_at) ? 'checked' : '' }} />
                                Published
                            </label>
                        </div>
                    </div>
