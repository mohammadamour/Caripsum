document.addEventListener("DOMContentLoaded", function () {
  ...
  const initImagePicker = () => {
    ...
    // Use DataTransfer to simulate an accumulated FileList
    ...
    fileInput.onchange = (ev) => {
      ...
      // Update the input's files property to include previous + new files
      fileInput.files = dataTransfer.files;

      // Re-render previews based on the COMPLETE list
